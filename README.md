...
这个项目旨在将微软的 OAuth2 认证取件流程封装成一个简单的 API，并部署在 Vercel 的无服务器平台上。通过这个 API，你可以轻松地在你的应用中进行OAuth2取件功能。
...
4. **开始使用**：
   ...
   - Vercel的链接在国内可能无法访问，请使用自己域名CNAME或使用Cloudflare进行代理。
...
欢迎大家贡献代码！如果你有任何问题或建议，请提交 Issue 或 Pull Request。
